...
export function Footer() {
  return <footer className="footer-ledger border-t border-slate-200 bg-slate-950 text-slate-300">
    <div className="site-container grid gap-10 py-12 md:grid-cols-[1fr_2.4fr]">
