...
export default function ReviewsPage() {
  return <main><article>
    ...
    <div className="site-container page-band reviews-directory">
      <div className="reviews-directory-intro"><h2 className="section-title">Choose the file type</h2><p>A review asks whether one product deserves a representative trial. A comparison applies the same brief to two tools. An alternatives page starts with the reason to switch and includes the option of keeping the incumbent.</p><p>Read the conclusion, evidence basis and limitation before the feature inventory. The final link should take you to the current official terms or the next operational check.</p><TrackedLink href="/compare" eventName="internal_link_click" eventParams={{placement:"reviews_intro",label:"Compare ecommerce tools"}} className="mt-5 inline-flex font-extrabold text-orange-700 hover:text-orange-900">Open the matched comparisons</TrackedLink></div>
      <ReviewsDirectory />
    </div>
  </article></main>;
}
