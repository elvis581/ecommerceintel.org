...
export const toolDirectoryItems: ToolDirectoryItem[] = [
  ...
  { name: "WinningHunter", category: "shopify", categoryLabel: "Shopify and ad intelligence", bestFor: "Connecting ads, stores, products and competitors", startingPrice: "$49/month public snapshot", evidence: "Official research and workflow evaluation", assessment: "Verify the current workflow", reviewHref: "/winninghunter-review" },
